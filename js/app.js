 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".quality__slider")) new swiper_core_Swiper(".quality__slider", {
                ...
                pagination: {
                    el: ".quality__dotts-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".quality__arrow--left",
                    nextEl: ".quality__arrow--right"
                },
                on: {}
            });
            ...
            if (document.querySelector(".service__slider")) new swiper_core_Swiper(".service__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".doctors__slider")) new swiper_core_Swiper(".doctors__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".doctors__arrow--left",
                    nextEl: ".doctors__arrow--right"
                },
                on: {}
            });
            if (document.querySelector(".csr__slider")) new swiper_core_Swiper(".csr__slider", {
                ...
                pagination: {
                    el: ".csr__dotts-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".csr__arrow--left",
                    nextEl: ".csr__arrow--right"
                },
                on: {}
            });
            if (document.querySelector(".spollers-csr__slider")) new swiper_core_Swiper(".spollers-csr__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                pagination: {
                    el: ".spollers-csr__dotts-pagination-spollers",
                    clickable: true
                },
                navigation: {
                    prevEl: ".spollers-csr__arrow--left",
                    nextEl: ".spollers-csr__arrow--right"
                },
                on: {}
            });
        }
        ...
        const buttonDrop = document.querySelector(".menu__btn-drop");
        const contentDrop = document.querySelector(".menu__content-drop");
        if (buttonDrop) buttonDrop.addEventListener("click", (function(e) {
            buttonDrop.classList.toggle("_sub-menu-show");
            if (contentDrop) contentDrop.classList.toggle("_sub-menu-show");
        }));
        function imageInit() {
            const images = document.querySelectorAll(".facility__image-item");
            if (images.length) images.forEach((image => {
                const imageItem = image.querySelector(".facility__image");
        ...
        function gridInit() {
            const items = document.querySelector(".facility__items");
            ...
            function documentActions(e) {
                const targetElement = e.target;
                if (targetElement.closest(".filter-facility__item")) {
                    const filterItem = targetElement.closest(".filter-facility__item");
                    const filterValue = filterItem.dataset.filter;
                    const filterActiveItem = document.querySelector(".filter-facility__item.active-btn");
                    filterValue === "*" ? itemsGrid.arrange({
                        filter: ``
                    }) : itemsGrid.arrange({
                        filter: `[data-filter="${filterValue}"]`
                    });
                    filterActiveItem.classList.remove("active-btn");
                    filterItem.classList.add("active-btn");
                    e.preventDefault();
                }
            }
        }
